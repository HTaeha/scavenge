...
export class MsgClientImpl {
    ...
    SubmitScavenge(request) {
        ...
        const promise = this.rpc.request('coreators.scavenge.scavenge.Msg', 'SubmitScavenge', data);
    ...
    CommitSolution(request) {
        ...
        const promise = this.rpc.request('coreators.scavenge.scavenge.Msg', 'CommitSolution', data);
    ...
    RevealSolution(request) {
        ...
        const promise = this.rpc.request('coreators.scavenge.scavenge.Msg', 'RevealSolution', data);
