...
export const protobufPackage = 'coreators.scavenge.scavenge'
...
export class QueryClientImpl implements Query {
  ...
  Scavenge(request: QueryGetScavengeRequest): Promise<QueryGetScavengeResponse> {
    ...
    const promise = this.rpc.request('coreators.scavenge.scavenge.Query', 'Scavenge', data)
  ...
  ScavengeAll(request: QueryAllScavengeRequest): Promise<QueryAllScavengeResponse> {
    ...
    const promise = this.rpc.request('coreators.scavenge.scavenge.Query', 'ScavengeAll', data)
  ...
  Commit(request: QueryGetCommitRequest): Promise<QueryGetCommitResponse> {
    ...
    const promise = this.rpc.request('coreators.scavenge.scavenge.Query', 'Commit', data)
  ...
  CommitAll(request: QueryAllCommitRequest): Promise<QueryAllCommitResponse> {
    ...
    const promise = this.rpc.request('coreators.scavenge.scavenge.Query', 'CommitAll', data)
